...
// get & counting hotspot users
 ...
 // get & counting Dhcp Lease 
	$countlease = $API->comm("/ip/dhcp-server/lease/print", array("count-only" => ""));
    if ($countlease < 2) {
    $uunit = "item";
  } elseif ($countlease > 1) {
    $uunit = "items";
            ...
            <div id="r_2" class="card">
              <div class="card-header text-center bg-blue">
                     <a onclick="cancelPage()" href="./?hotspot=users&profile=all&session=<?= $session; ?>">
                         <h3><i class="fa fa-users"></i> <?= $hotspotname; ?> <?= $countallusers; ?>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-3 col-box-6">
                    <div class="box bg-pink bmh-75">
                      <a onclick="cancelPage()" href="./?hotspot=dhcp-leases&session=<?= $session; ?>">
                            <h1>
                            <?php
                            if ($countlease < 2) {
                            	echo "$countlease";
